...
public class EmailShare extends ShareService {
   ...
   /* public EmailShare(String tunidiscovery2gmailcom, String tuniDiscovery, String email, String tuniDiscoveryteam, String message) {
                    ...
                    public void run() {
                        ...
                        contacts.addActionListener(new ActionListener() {
                            ...
                            public void actionPerformed(ActionEvent evt) {
                                ...
                                if(image == null){
                                    f[0] = new ShareForm(contactsForm, "Send Email", "tunidiscovery2@gmail.com", toShare,
                                            new ActionListener() {

                                                public void actionPerformed(ActionEvent evt) {
                                                    String [] recieptents = new String[1];
                                                    recieptents[0] = "tunidiscovery2@gmail.com";
                                    ...
                                    f[0] = new ShareForm(contactsForm, "Send Email", "tunidiscovery2@gmail.com", toShare, image,
                                            new ActionListener() {
