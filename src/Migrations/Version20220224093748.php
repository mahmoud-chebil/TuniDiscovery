 ...
 */
final class Version20220224093748 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE devis DROP reservation_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE devis ADD reservation_id INT DEFAULT NULL, CHANGE code_devis code_devis VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
