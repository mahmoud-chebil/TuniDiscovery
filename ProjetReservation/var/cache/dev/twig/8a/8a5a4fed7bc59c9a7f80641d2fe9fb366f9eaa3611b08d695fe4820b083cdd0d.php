...
class __TwigTemplate_c2e40e7a3f1beaf4506fc0428a12b258ef8a607c6ee426395c282027a5952a73 extends Template
{
    ...
    <button class=\"btn\">";
        // line 3
        echo twig_escape_filter($this->env, ((array_key_exists("button_label", $context)) ? (_twig_default_filter((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 3, $this->source); })()), "Réserver")) : ("Réserver")), "html", null, true);
        echo "</button>
";
        // line 4
...
{{ form_end(form) }}
", "reservation/_form.html.twig", "C:\\xampp\\htdocs\\ProjetReservation\\templates\\reservation\\_form.html.twig");
    }
}
