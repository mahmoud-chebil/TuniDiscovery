...
public class ListReservationForm extends Form{
    ...
    public  Container  addItem(Reservation r)
    {
        ...
        btnvalide.addActionListener(e ->{
             ...
             { if(ServiceReservation.validerReservation(r.getId()))
                ...
                new ListReservationForm(current).show();
                } 
             else
                 new ListReservationForm(current).show() ;
             }
    ...
    public ListReservationForm(Form previous) {
       ...
       getToolbar().addMaterialCommandToLeftBar("", FontImage.MATERIAL_ARROW_BACK, e-> previous.showBack());
        ...
        Image profilePic = res.getImage("liste.JPG");
        Image mask = res.getImage("round-mask.png");
        profilePic = profilePic.fill(mask.getWidth(), mask.getHeight());
        Label profilePicLabel = new Label(profilePic, "ProfilePicTitle");
        profilePicLabel.setMask(mask.createMask());
       
        Label lab=new Label("Réservations", "Title");
       ...
       cb.addActionListener(e -> {
          if(cb.getSelectedItem().toString()=="All")
            new ListReservationForm(current).show();    
       if(cb.getSelectedItem().toString()=="validée")
           new listeresvalide(current).show(); 
      if(cb.getSelectedItem().toString()=="En attente")
           new listeenattente(current).show();
      if(cb.getSelectedItem().toString()=="Annulée")
           new listeAnnuleeForm(current).show();
       });
        getToolbar().addMaterialCommandToLeftBar("", FontImage.MATERIAL_ARROW_BACK, e-> previous.showBack());
