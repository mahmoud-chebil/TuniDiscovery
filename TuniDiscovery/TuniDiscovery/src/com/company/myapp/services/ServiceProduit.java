...
public class ServiceProduit {
    ...
    public static ServiceProduit getInstance() {
     ...
     public boolean addProduit(Product p,String tp) {
        String url = Statics.BASE_URL + "/product/add_jason"
                + "/" + p.getName()
                + "/" + p.getDescription()
                + "/" + p.getImage()
                + "/" +p.getPrice()    
     ...
     public boolean deleteProduit(Product p) {
        String url = Statics.BASE_URL + "/product/remove_json/" + p.getId();
     ...
     public ArrayList<Product> parseProduits(String jsonText){
        try {
            ...
            for(Map<String,Object> obj : list){
              ...
              //  p.setCategory_name(obj.get("Category").toString());
//             
...
//                
     ...
     public ArrayList<Product> getHighProduits(){
      ...
      public ArrayList<Product> getProduitSingle(Product p){
         ...
         String url = Statics.BASE_URL+"/product/ShowMobileSingle/"+ p.getId();
        req.setUrl(url);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
       ...
       public boolean UpdateProduit(Product p ,String tp) {
         String url = Statics.BASE_URL + "/product/update_json/" + p.getId()
                + "/" + p.getName()
                 + "/" +tp
                + "/" + p.getDescription()
                + "/" +p.getPrice()    ;
